const projectDetails = {
    "impact":{
        ...
        content: `
            <img src="/images/impact/impact.jpg" data-full-src="/images/impact/impact.jpg" alt="Poster for Time to Impact!" class="blog-image full">

            <p>
                <a href="https://fractaldev.itch.io/time-to-impact" target="_blank" class="project-button">View official page</a>
                <a href="https://www.youtube.com/watch?v=E9K7pVmvFpQ" target="_blank" class="project-button secondary">View trailer</a>
            </p>
